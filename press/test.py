...
percent = 56
print 'Adding partion using ' + \
        'add_partition_percent(\'percent_example\', \'ext4\', %s)' % percent
layout.add_partition_percent('percent_example', 'ext4', percent)
print 'Success!'
print 'Adding partition using ' + \
        'add_partition_fill(\'left_over\', \'ext4\')'
